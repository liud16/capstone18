...
#within a time array
x0_1_shift = spectral_shift(950, 1300, time)

#generate an array of peak positions that shifts from 1300 to 1200
#within a time array
x0_2_shift = spectral_shift(1300, 1100, time)
...
output[0, 1:] = time
output[1:, 0] = nm
outfile = np.savetxt(date + '_twogaussian_spectralshfit_past.txt', output, fmt='%.3e', delimiter='\t')
