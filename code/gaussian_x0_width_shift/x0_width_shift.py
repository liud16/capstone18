...
savename = 'twogaussian_spectralshift_widthchange'
plt.figure()
#plt.xlim(450,800)
plt.title('2 peaks both red shifting in time at \ndifferent rates, changing width', fontsize = 16, fontweight = 'bold')
#plt.ylim(0,50)
